...
- [Process-Management-Simulation](https;//github.com/SteliosSpanos/process-management): A C-based operating system simulation that implements process creation, memory management and scheduling using dynamically manages linked-list queues. (C)
